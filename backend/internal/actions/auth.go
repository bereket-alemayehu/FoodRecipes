...
func SignupHandler(w http.ResponseWriter, r *http.Request) {
         log.Println("SignupHandler: Received signup request")
    ...
    if err := json.NewDecoder(r.Body).Decode(&signupInput); err != nil {
      ...
      log.Println("SignupHandler: Decoded request body:", signupInput)
    ...
    log.Println("SignupHandler: Password hashed successfully")
    ...
    log.Println("SignupHandler: GraphQL request created:", req)
    ...
    if err := graphqlClient.Run(context.Background(), req, &respData); err != nil {
        log.Println("SignupHandler: Error executing GraphQL request:", err)
    log.Println("SignupHandler: Raw GraphQL response:", respData) 
        http.Error(w, "Failed to create user", http.StatusInternalServerError)
        return
    }

    log.Println("SignupHandler: GraphQL request executed successfully:", respData)

    output := SignupOutput{
        ID:       respData.InsertUsersOne.ID,
        Username: respData.InsertUsersOne.Username,
        Email:    respData.InsertUsersOne.Email,
    }
