...
func CreateRecipeHandler(w http.ResponseWriter, r *http.Request) {
        ...
        req := graphql.NewRequest(`
                mutation ($title: String!, $description: String!, $categoryId: String!, $preparationTime: Int!, $ingredients: jsonb!, $steps: jsonb!, $images: _text!, $featuredImage: String!, $userId: String!) {
...
func UpdateRecipeHandler(w http.ResponseWriter, r *http.Request) {
        ...
        req := graphql.NewRequest(`
                mutation ($id: uuid!, $title: String!, $description: String!, $categoryId: String!, $preparationTime: Int!, $ingredients: jsonb!, $steps: jsonb!, $images: _text!, $featuredImage: String!) {
